...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent requireNormalTextureText= EditorGUIUtility.TrTextContent("Normal Texture", "must enable depthTexture _CameraDepthTexture._CameraNormalTexture");
            ...
            public static GUIContent shadowFarCascadesSplitText = EditorGUIUtility.TrTextContent("Far Cascade Distance Split","Far Cascade Distance Split");
        ...
        SerializedProperty m_RequireNormalTextureProp;
        ...
        SerializedProperty m_ShadowCascadeFarShadowSplit;
        SerializedProperty m_ShadowCascadeFarCascade2Split;
        SerializedProperty m_ShadowCascadeFarCascade3Split;
        SerializedProperty m_ShadowCascadeFarCascade4Split;
        ...
        void OnEnable()
        {
            ...
            m_RequireNormalTextureProp = serializedObject.FindProperty("m_RequireNormalTexture");
            ...
            m_ShadowCascadeFarShadowSplit = serializedObject.FindProperty("m_FarShadowSplit");
            m_ShadowCascadeFarCascade2Split = serializedObject.FindProperty("m_FarCascade2Split");
            m_ShadowCascadeFarCascade3Split = serializedObject.FindProperty("m_FarCascade3Split");
            m_ShadowCascadeFarCascade4Split = serializedObject.FindProperty("m_FarCascade4Split");
        ...
        void DrawGeneralSettings()
        {
            ...
            if (m_GeneralSettingsFoldout.value)
            {
                ...
                {
                    EditorGUILayout.PropertyField(m_RequireNormalTextureProp, Styles.requireNormalTextureText);
                }
        ...
        void DrawShadowSettings()
        {
            ...
            if (m_ShadowSettingsFoldout.value)
            {
                ...
                if(cascadeCount > 4)
                {
                    EditorGUILayout.Slider(m_ShadowCascadeFarShadowSplit, 0.1f, 1.0f, Styles.shadowFarCascadesSplitText);
                ...
                float nearCascadeShadowDist = m_ShadowDistanceProp.floatValue * (m_ShadowCascadeFarShadowSplit.floatValue);
                float farCascadeShadowDist = m_ShadowDistanceProp.floatValue * (1 - m_ShadowCascadeFarShadowSplit.floatValue);
                switch(cascadeCount)
                {
                    case 1:
                        EditorUtils.DrawCascadeSplitGUI<float>(ref m_ShadowCascade2SplitProp, m_ShadowDistanceProp.floatValue, cascadeCount, unit);
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        EditorUtils.DrawCascadeSplitGUI<Vector3>(ref m_ShadowCascade4SplitProp, nearCascadeShadowDist, 4, unit);

                        EditorUtils.DrawCascadeSplitGUI<float>(ref m_ShadowCascadeFarCascade2Split, farCascadeShadowDist, cascadeCount-4, unit);
                        break;
                    case 6:
                        EditorUtils.DrawCascadeSplitGUI<Vector3>(ref m_ShadowCascade4SplitProp, nearCascadeShadowDist, 4, unit);
                        EditorUtils.DrawCascadeSplitGUI<float>(ref m_ShadowCascadeFarCascade2Split, farCascadeShadowDist, cascadeCount-4, unit);
                    ...
                    case 7:
                        EditorUtils.DrawCascadeSplitGUI<Vector3>(ref m_ShadowCascade4SplitProp, nearCascadeShadowDist, 4, unit);
                        EditorUtils.DrawCascadeSplitGUI<Vector2>(ref m_ShadowCascadeFarCascade3Split, farCascadeShadowDist, cascadeCount-4, unit);
                        break;
                    case 8:
                        EditorUtils.DrawCascadeSplitGUI<Vector3>(ref m_ShadowCascade4SplitProp, nearCascadeShadowDist, 4, unit);
                        EditorUtils.DrawCascadeSplitGUI<Vector3>(ref m_ShadowCascadeFarCascade4Split, farCascadeShadowDist, cascadeCount-4, unit);
                        break;
                }
