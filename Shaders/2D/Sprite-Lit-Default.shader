Shader "Universal Render Pipeline/2D/Sprite-Lit-Default"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/MyRenderPipeline/Shaders/2D/Include/LightingUtility.hlsl"
            ...
            #include "Assets/MyRenderPipeline/Shaders/2D/Include/CombinedShapeLightShared.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/MyRenderPipeline/Shaders/2D/Include/NormalsRenderingShared.hlsl"
