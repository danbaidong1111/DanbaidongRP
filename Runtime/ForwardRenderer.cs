...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class ForwardRenderer : ScriptableRenderer
    {
        ...
        DrawObjectsPass m_DrawCloudPass;
...
#pragma warning restore 414
        ...
        public ForwardRenderer(ForwardRendererData data) : base(data)
        {
            ...
            m_CopyDepthMaterial = CoreUtils.CreateEngineMaterial(data.shaders.copyDepthPS);Debug.Log(data.shaders.copyDepthPS+"??");
            ...
            ShaderTagId[] cloudTagIds = new ShaderTagId[]
            {
                new ShaderTagId("CloudAfterSkybox")
            };
            m_DrawCloudPass = new DrawObjectsPass("DrawCloudPass", cloudTagIds, false, RenderPassEvent.BeforeRenderingSkybox + 1, RenderQueueRange.transparent, data.transparentLayerMask, m_DefaultStencilState, stencilData.stencilReference);
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            {
                if (renderPassInputs.requiresNormalsTexture || cameraData.requiresDepthNormalTexture)
                {
