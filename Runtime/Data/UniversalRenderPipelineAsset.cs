...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] bool m_RequireNormalTexture = false;
        ...
        [SerializeField] float m_FarShadowSplit = 0.5f;
        [SerializeField] float m_FarCascade2Split = 0.25f;
        [SerializeField] Vector2 m_FarCascade3Split = new Vector2(0.1f, 0.3f);
        [SerializeField] Vector3 m_FarCascade4Split = new Vector3(0.25f, 0.25f, 0.25f);
        ...
        public bool supportsCameraDepthNormalTexture
        {
            get { return m_RequireDepthTexture && m_RequireNormalTexture; }
            set { m_RequireDepthTexture = value;m_RequireNormalTexture = value; }
        }
        ...
        public float farShadowSplit
        {
            get { return m_FarShadowSplit; }
        }

        public float farCascade2Split
        {
            get { return m_FarCascade2Split; }
        }
        public Vector2 farCascade3Split
        {
            get { return m_FarCascade3Split; }
        }
        public Vector3 farCascade4Split
        {
            get { return m_FarCascade4Split; }
        }

        public float[] getCascadesSplitArray()
        {
            float[] cascades = new float[shadowCascadeCount];
            cascades[shadowCascadeCount - 1] = 1.0f;
            float farCascadeScale = 1 - m_FarShadowSplit;
            switch(shadowCascadeCount)
            {
                case 1:
                    ...
                    break;
                case 2:
                    cascades[0] = m_Cascade2Split;
                    break;
                case 3:
                    cascades[0] = m_Cascade3Split.x;
                    cascades[1] = m_Cascade3Split.y;
                    break;
                case 4:
                    cascades[0] = m_Cascade4Split.x;
                    cascades[1] = m_Cascade4Split.y;
                    cascades[2] = m_Cascade4Split.z;
                    break;
                case 5:
                    cascades[0] = m_Cascade4Split.x * m_FarShadowSplit;
                    cascades[1] = m_Cascade4Split.y * m_FarShadowSplit;
                    cascades[2] = m_Cascade4Split.z * m_FarShadowSplit;
                    cascades[3] = m_FarShadowSplit;
                    break;
                case 6:
                    cascades[0] = m_Cascade4Split.x * m_FarShadowSplit;
                    cascades[1] = m_Cascade4Split.y * m_FarShadowSplit;
                    cascades[2] = m_Cascade4Split.z * m_FarShadowSplit;
                    cascades[3] = m_FarShadowSplit;
                    cascades[4] = m_FarShadowSplit + m_FarCascade2Split * farCascadeScale;
                    break;
                case 7:
                    cascades[0] = m_Cascade4Split.x * m_FarShadowSplit;
                    cascades[1] = m_Cascade4Split.y * m_FarShadowSplit;
                    cascades[2] = m_Cascade4Split.z * m_FarShadowSplit;
                    cascades[3] = m_FarShadowSplit;
                    cascades[4] = m_FarShadowSplit + m_FarCascade3Split.x* farCascadeScale;
                    cascades[5] = m_FarShadowSplit + m_FarCascade3Split.y* farCascadeScale;
                    break;
                case 8:
                    cascades[0] = m_Cascade4Split.x * m_FarShadowSplit;
                    cascades[1] = m_Cascade4Split.y * m_FarShadowSplit;
                    cascades[2] = m_Cascade4Split.z * m_FarShadowSplit;
                    cascades[3] = m_FarShadowSplit;
                    cascades[4] = m_FarShadowSplit + m_FarCascade4Split.x* farCascadeScale;
                    cascades[5] = m_FarShadowSplit + m_FarCascade4Split.y* farCascadeScale;
                    cascades[6] = m_FarShadowSplit + m_FarCascade4Split.z* farCascadeScale;
                    break;
            }
